...
public class Game {
  ...
  private static void backstory() {
    ...
    String line = "Superbowl Sunday, 1995. You and your buddies have all\n" +
                  ...
                  "sucked up into the hull of an enormous disk-shaped alien craft.\n" +
                  "Waking up in your cell, you begin to look for ways\n" +
                  "to escape.\n";
